...
exports.config = {
  ...
  reporters: [
    ...
    ['allure', {
      outputDir: './reports/UI/allure-results',
  ...
  cucumberOpts: {
    ...
    require: ['./stepDefinitions/UI/**/*.js', './stepDefinitions/API/**/*.js'],
  ...
  // beforeStep() {
  //   if ($('#ui-global-loader').isDisplayed()) {
  //     $('#ui-global-loader').waitForDisplayed({ timeout: 30000, reverse: true });
  //   }
  //   // if ($('.maintenance-modal').isDisplayed()) {
  //   //   $('.btn=Close').click();
  //   // }
  // },
  /**
